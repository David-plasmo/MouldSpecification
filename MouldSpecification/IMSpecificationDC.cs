...
namespace MouldSpecification
{
    public class IMSpecificationDC
    {
        ...
        public bool FamilyMould { get; set; }
        ...
        public bool AdditionalLabourReqd { get; set; }
        public string last_updated_by { get; set; }
        public DateTime last_updated_on { get; set; }

        public IMSpecificationDC(int MouldID_, int ItemID_, string MouldNumber_, string MouldLocation_, string MouldOwner_, bool FamilyMould_, int NoOfCavities_, int NoOfPart_, string PartSummary_, string Operation_, string OtherFeatures_, string FixedHalf_, string FixedHalfTemp_, string MovingHalf_, string MovingHalfTemp_, string PremouldReq_, string PostMouldReq_, bool AdditionalLabourReqd_, string last_updated_by_, DateTime last_updated_on_)
        {
