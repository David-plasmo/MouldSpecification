...
namespace MouldSpecification
{
    public class QualityControlDC
    {
        ...
        public Boolean ProductSample { get; set; }
        public Boolean CertificateOfConformance { get; set; }
        ...
        public QualityControlDC(int QualityControlID_, int ItemID_, string FinishedPTQC_, Boolean ProductSample_, Boolean CertificateOfConformance_, string Notes_, string LabelIcon_, string Costing_, string last_updated_by_, DateTime last_updated_on_)
        {
