...
namespace MouldSpecification
{
    public class MasterBatchCompDC
    {
        ...
        public MasterBatchCompDC(int MBCompID_, int MBID_, int ItemID_, int MB123_, Single MBPercent_, Boolean IsPreferred_, int AdditiveID_, Single AdditivePC_, string last_updated_by_, DateTime last_updated_on_)
        {
