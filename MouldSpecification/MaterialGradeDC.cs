...
namespace MouldSpecification
{
    public class MaterialGradeDC
    {
        ...
        public MaterialGradeDC(int MaterialGradeID_, int MaterialID_, string MaterialGrade_, decimal CostPerKg_, string Supplier_, string Comment_, string MachineType_, string last_updated_by_, DateTime last_updated_on_)
        {
