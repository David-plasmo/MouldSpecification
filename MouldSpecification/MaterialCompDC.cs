...
namespace MouldSpecification
{
    public class MaterialCompDC
    {
        ...
        public MaterialCompDC(int MaterialCompID_, int MaterialGradeID_, int ItemID_, int Polymer123_, Single PolymerPercent_, Single RegrindMaxPC_, bool IsActive_, string last_updated_by_, DateTime last_updated_on_)
        {
